...
namespace Fphi.CabinPi.Common.Services
{
    ...
    public static class SampleDataService
    {
        ...
        public static ObservableCollection<Fphi.CabinPi.Common.Models.DataPoint> GetChartSampleData()
        {
            var data = AllOrders().Select(o => new Fphi.CabinPi.Common.Models.DataPoint() { Category = o.Company, Value = o.OrderTotal })
                                  .OrderBy(dp => dp.Category);

            return new ObservableCollection<Fphi.CabinPi.Common.Models.DataPoint>(data);
        }
